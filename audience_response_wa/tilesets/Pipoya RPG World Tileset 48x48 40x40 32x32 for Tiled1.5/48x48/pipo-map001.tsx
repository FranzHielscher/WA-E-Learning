...
<tileset version="1.5" tiledversion="1.5.0" name="pipo-map001" tilewidth="48" tileheight="48" tilecount="136" columns="8">
 <image source="pipo-map001.png" width="384" height="816"/>
 <wangsets>
